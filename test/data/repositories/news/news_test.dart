...
import 'package:ppidunia/features/news/data/repositories/news.dart';
...
void main() {
  const String path = "${ApiConsts.baseUrl}/api/v1/news";
  ...
  group('News Api Test (repository)', () {
    ...
    test(
      ...
      () {
        ...
        final responseBody = MockDioHelper.getSuccessResponse(
            path: path, data: mockResponseData);
