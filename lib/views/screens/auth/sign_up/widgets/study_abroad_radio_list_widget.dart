...
class StudyAbroadRadioList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<StudyAbroadStatusScreenModel>(
        ...
        return Wrap(
          children: [
            RadioListTile(
              ...
              onChanged: (value) => model.setselectedStudyAbroadOption(context, value!, model),
              title: Text(getTranslated('STUDY_ABROAD_OPTION_1'),
            ...
            RadioListTile(
              ...
              groupValue: model.selectedStudyAbroadOption,
              onChanged: (value) => model.setselectedStudyAbroadOption(context, value!, model),
              title: Text(getTranslated('STUDY_ABROAD_OPTION_2'),
                style: sfProRegular.copyWith(
                  fontSize: Dimensions.fontSizeExtraLarge,
                ),
              ),
