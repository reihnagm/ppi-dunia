...
import 'package:ppidunia/views/screens/auth/sign_up/widgets/sign_up_buttons_widget.dart';
import 'package:ppidunia/views/screens/auth/sign_up/widgets/sign_up_form_widget.dart';
...
import 'package:ppidunia/views/screens/auth/sign_up/first_step_screen/sign_up_state.dart';
            ...
            child: SingleChildScrollView(
              child: Wrap(
                children: [
                  AuthColumnWidget(
                    screenSize: screenSize,
                    top: Text(getTranslated('SIGN_UP_HERE'),
