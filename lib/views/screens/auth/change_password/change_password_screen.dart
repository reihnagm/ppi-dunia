...
import 'package:ppidunia/views/screens/auth/change_password/change_password_state.dart';
import 'package:ppidunia/views/screens/auth/change_password/widgets/change_password_button.dart';
import 'package:ppidunia/views/screens/auth/change_password/widgets/change_password_form.dart';
          ...
          child: GreyBackgroundWidget(
            ...
            child: SingleChildScrollView(
              child: AuthColumnWidget(
                screenSize: screenSize,
                  top: Text(getTranslated('CHANGE_PASSWORD_HERE'),
