...
import 'package:ppidunia/views/screens/auth/sign_in/widgets/sign_in_buttons_widget.dart';
import 'package:ppidunia/views/screens/auth/sign_in/widgets/sign_in_form_widget.dart';
                  ...
                  screenSize: screenSize,
                    top: Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Image.asset('assets/images/auth/sign-in.png',
                            height: screenSize.height * 0.25,
                            fit: BoxFit.fill,
                          ),
                          Padding(
                            padding: const EdgeInsets.only(top: 50.0),
                            child: Text(getTranslated('SIGN_IN_HERE'),
