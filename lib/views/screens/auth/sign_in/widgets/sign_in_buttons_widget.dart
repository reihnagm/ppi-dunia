  ...
  Widget build(BuildContext context) {
    return Wrap(
      children: [
        Column(
          children: [
            Consumer<SignInScreenModel>(
              builder: (context, model, _) {
                return CustomButton(
                  isLoading: model.loginStatus == LoginStatus.loading ? true : false,
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(text: getTranslated('NO_ACCOUNT'), ),
                      TextSpan(text: '  ${getTranslated('NO_ACCOUNT_TOGGLE')}',
