                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    SliverAppBar(
                      ...
                      title: Text(getTranslated("PROFILE"),
                      ...
                      delegate: SliverChildListDelegate([
                        ...
                        Stack(
                          ...
                          children: [
                            ...
                            Image.asset('assets/images/card/ic-card.png',
                                      ...
                                      Stack(
                                        ...
                                        children: [
                                          ...
                                          ? CircleAvatar(
                                              ...
                                              backgroundImage:  FileImage(File(pp.file!.path)),
                                            ) 
                          ...
                          builder: (BuildContext context, ProfileProvider pp, Widget? child) {
                            ...
                            if(pp.feedStatus == FeedStatus.empty) {
                              return SizedBox(
                                height: 150.0,
                                child: Center(
                                  child: Text(getTranslated("NO_POST"),
                                    style: const TextStyle(
                                      color: ColorResources.greyLightPrimary,
                                      fontSize: Dimensions.fontSizeOverLarge,
                                      fontWeight: FontWeight.w600,
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          pp.feeds[i].user.uid == SharedPrefs.getUserId() 
                                                          ? PopupMenuButton(
                                                              color: ColorResources.white,
                                                      ...
                                                      if(pp.feeds[i].feedType == "image")
                                                        ...
                                                        if(pp.feeds[i].media.length == 1)
                                                          CachedNetworkImage(
                                                            imageUrl: pp.feeds[i].media[0].path,
                                                          ...
                                                          CarouselSlider.builder(
                                                            ...
                                                            itemBuilder: (BuildContext context, int i, int z) {
                                                              return  CachedNetworkImage(
                                                                imageUrl: pp.feeds[i].media[i].path,
                                                                imageBuilder: (BuildContext context, ImageProvider imageProvider) {
                                                                  return Container(
                                                                    decoration: BoxDecoration(
                                                                      image: DecorationImage(
                                                        ...
                                                        if(pp.feeds[i].feedType == "video")
                                                          VideoPlay(dataSource: pp.feeds[i].media[0].path),
                                                              ...
                                                              children: [
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    SizedBox(
                                                                      width: 150.0,
                                                                      child: Text(pp.feeds[i].media[0].path.split('/').last,
                                                                        maxLines: 3,
                                                                        overflow: TextOverflow.ellipsis,
                                                                        style: const TextStyle(
                                                                          color: ColorResources.white,
                                                                ...
                                                                IconButton(
                                                                  ...
                                                                  onPressed: () async {
                                                                    await Helper.downloadDoc(context: context, url: pp.feeds[i].media[0].path);
                                                                  },
                                                                  color: ColorResources.white,
                                                                )
                                                    ...
                                                    children: [
                                                      ...
                                                      Material(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          child: Padding(
                                                            padding: const EdgeInsets.all(5.0),
                                                            child: pp.feeds[i].feedLikes.likes.where((el) => el.user.uid == SharedPrefs.getUserId()).isEmpty 
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              mainAxisSize: MainAxisSize.max,
                                                              children: [
                                                                pp.feeds[i].feedComments.comments.isEmpty 
                                                                ...
                                                                pp.feeds[i].feedComments.comments.isEmpty 
                                                                ? const SizedBox() 
                                                                : Text(pp.feeds[i].feedComments.comments.length.toString(),
                                                                  style: const TextStyle(
                                                                    color: ColorResources.white,
                                                                    fontSize: Dimensions.fontSizeDefault,
                                                                    fontWeight: FontWeight.w600,
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            await pp.toggleBookmark(
                                                              feedId: pp.feeds[i].uid,
                                                              feedBookmarks: pp.feeds[i].feedBookmarks
                                                            );
                                                          },
                                                          child: Padding(
                                                            padding: const EdgeInsets.all(8.0),
                                                            child: pp.feeds[i].feedBookmarks.bookmarks.where((el) => el.user.uid == SharedPrefs.getUserId()).isEmpty 
