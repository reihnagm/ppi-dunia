                                ...
                                children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                            ...
                                            Container(
                                              ...
                                              child: Text(fsm.feeds[i].user.name,
                                                maxLines: 2,
                                  ...
                                  if(fsm.feeds[i].feedType == "image")
                                    ...
                                    if(fsm.feeds[i].media.length == 1)
                                      CachedNetworkImage(
                                        imageUrl: fsm.feeds[i].media[0].path,
                                      ...
                                      CarouselSlider.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int i, int z) {
                                          return  CachedNetworkImage(
                                            imageUrl: fsm.feeds[i].media[i].path,
                                            imageBuilder: (BuildContext context, ImageProvider imageProvider) {
                                              return Container(
                                                decoration: BoxDecoration(
                                                  image: DecorationImage(
                                        ...
                                        children: fsm.feeds[i].media.map((z) {
                                          ...
                                          return Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              color: fsm.currentIndexMultipleImg == index
                                    ...
                                    if(fsm.feeds[i].feedType == "video")
                                      VideoPlay(dataSource: fsm.feeds[i].media[0].path),
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  width: 150.0,
                                                  child: Text(fsm.feeds[i].media[0].path.split('/').last,
                                                    maxLines: 3,
                                                    overflow: TextOverflow.ellipsis,
                                                    style: const TextStyle(
                                                      color: ColorResources.white,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(fsm.feeds[i].media[0].size.toString(),      
                                                      style: const TextStyle(
                                                        color: ColorResources.white,
                                                        fontSize: Dimensions.fontSizeDefault,
                                                        fontWeight: FontWeight.w600,
                                            ...
                                            IconButton(
                                              ...
                                              onPressed: () async {
                                                await Helper.downloadDoc(context: context, url: fsm.feeds[i].media[0].path);
                                              },
                                              color: ColorResources.white,
                                            )
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          mainAxisSize: MainAxisSize.max,
                                          children: [
                                            fsm.feeds[i].feedComments.comments.isEmpty 
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        await fsm.toggleBookmark(
                                          feedId: fsm.feeds[i].uid,
                                          feedBookmarks: fsm.feeds[i].feedBookmarks
                                        );
                                        fsm.panelC.open();
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: fsm.feeds[i].feedBookmarks.bookmarks.where((el) => el.user.uid == SharedPrefs.getUserId()).isEmpty 
