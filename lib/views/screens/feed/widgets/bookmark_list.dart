      ...
      builder: (BuildContext context, BookmarkScreenModel bsm, Widget? child) {
        ...
        if(bsm.bookmarkStatus == BookmarkStatus.empty) {
          return SizedBox(
            height: MediaQuery.of(context).size.height * .75,
            child: Center(
              child: Text(getTranslated("NO_BOOKMARK"),
                style: const TextStyle(
                  color: ColorResources.greyLightPrimary,
                  fontSize: Dimensions.fontSizeOverLarge,
                  fontWeight: FontWeight.w600,
                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                            ...
                                            SizedBox(
                                              width: 110.0,
                                              child: Text(bsm.feeds[i].user.name,
                                                maxLines: 2,
                                      ...
                                      bsm.feeds[i].user.uid == SharedPrefs.getUserId() 
                                      ? PopupMenuButton(
                                          color: ColorResources.white,
                                          itemBuilder: (BuildContext buildContext) { 
                                            return [
                                              PopupMenuItem(
                                                value: "/delete",
                                                child: Text(getTranslated("DELETE"),
                                                style: const TextStyle(
                                                    color: ColorResources.greyDarkPrimary,
                                                    fontSize: Dimensions.fontSizeDefault,
                                                    fontWeight: FontWeight.w600,
                                  ...
                                  if(bsm.feeds[i].feedType == "image")
                                    ...
                                    if(bsm.feeds[i].media.length == 1)
                                      CachedNetworkImage(
                                        imageUrl: bsm.feeds[i].media[0].path,
                                      ...
                                      CarouselSlider.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int i, int z) {
                                          return  CachedNetworkImage(
                                            imageUrl: bsm.feeds[i].media[i].path,
                                            imageBuilder: (BuildContext context, ImageProvider imageProvider) {
                                              return Container(
                                                decoration: BoxDecoration(
                                                  image: DecorationImage(
                                        ...
                                        children: bsm.feeds[i].media.map((z) {
                                          ...
                                          return Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              color: bsm.currentIndexMultipleImg == index
                                    ...
                                    if(bsm.feeds[i].feedType == "video")
                                      VideoPlay(dataSource: bsm.feeds[i].media[0].path),
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  width: 150.0,
                                                  child: Text(bsm.feeds[i].media[0].path.split('/').last,
                                                    maxLines: 3,
                                                    overflow: TextOverflow.ellipsis,
                                                    style: const TextStyle(
                                                      color: ColorResources.white,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(bsm.feeds[i].media[0].size.toString(),      
                                                      style: const TextStyle(
                                                        color: ColorResources.white,
                                                        fontSize: Dimensions.fontSizeLarge,
                                                        fontWeight: FontWeight.w600,
                                            ...
                                            IconButton(
                                              ...
                                              onPressed: () async {
                                                await Helper.downloadDoc(context: context, url: bsm.feeds[i].media[0].path);
                                              },
                                              color: ColorResources.white,
                                            )
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        await bsm.toggleLike(
                                          feedId: bsm.feeds[i].uid,
                                          feedLikes: bsm.feeds[i].feedLikes
                                        );
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(5.0),
                                        child: bsm.feeds[i].feedLikes.likes.where((el) => el.user.uid == SharedPrefs.getUserId()).isEmpty 
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          mainAxisSize: MainAxisSize.max,
                                          children: [
                                            bsm.feeds[i].feedComments.comments.isEmpty 
                                            ...
                                            bsm.feeds[i].feedComments.comments.isEmpty 
                                            ? const SizedBox() 
                                            : Text(bsm.feeds[i].feedComments.comments.length.toString(),
                                              style: const TextStyle(
                                                color: ColorResources.white,
                                                fontSize: Dimensions.fontSizeDefault,
                                                fontWeight: FontWeight.w600,
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        await bsm.toggleBookmark(
                                          feedId: bsm.feeds[i].uid,
                                          feedBookmarks: bsm.feeds[i].feedBookmarks
                                        );
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: bsm.feeds[i].feedBookmarks.bookmarks.where((el) => el.user.uid == SharedPrefs.getUserId()).isEmpty 
