              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  Consumer<InboxScreenModel>(
                    builder: (BuildContext context, InboxScreenModel ism, Widget? child) {
                      ...
                      if(ism.inboxStatus == InboxStatus.empty) {
                        return SliverFillRemaining(
                          hasScrollBody: false,
                          child: Center(
                            child: Text(getTranslated("NO_INBOX"),
                              style: const TextStyle(
                                color: ColorResources.greyLightPrimary,
                                fontSize: Dimensions.fontSizeOverLarge,
                                fontWeight: FontWeight.w600,
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                                    ...
                                                    InkWell(
                                                      onTap: () async {
                                                        if(Platform.isAndroid) {
                                                          Uri uri = Uri.parse("google.navigation:q=${ism.id[i].lat},${ism.id[i].lng}&mode=d");
                                                          ...
                                                          String urlAppleMaps = 'https://maps.apple.com/?q=${ism.id[i].lat},${ism.id[i].lng}';
                                                          String url = 'comgooglemaps://?saddr=&daddr=${ism.id[i].lat},${ism.id[i].lng}&directionsmode=driving';
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(getTranslated("LOOK_ON_THE_MAP"),
                                                          style: const TextStyle(
                                                            color: ColorResources.greyDarkPrimary,
                                                            fontSize: Dimensions.fontSizeLarge,
                                                            fontWeight: FontWeight.w400,
                                    ...
                                    await ism.inboxDetail(inboxId: ism.id[i].id!);
                                  },
                                  child: Padding(
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  width: 300.0,
                                                  child: Text(ism.id[i].description!,
