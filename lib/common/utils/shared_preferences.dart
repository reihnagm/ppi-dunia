...
class SharedPrefs {
  ...
  static void writeRegCountryId(String? value) {
    _instance!.setString(
        'reg_country_id', value ?? "19021987-fa82-4de8-82aa-ad6f8d55977f");
  }
  ...
  static String getLanguageCode() {
    return _instance!.getString(ApiConsts.languageCode) ?? 'en';
  }

  static String getCountryCode() {
    return _instance!.getString(ApiConsts.countryCode) ?? 'US';
  }

  static void saveLanguagePrefs(Locale locale) {
    _instance!.setString(ApiConsts.languageCode, locale.languageCode);
    _instance!.setString(ApiConsts.countryCode, locale.countryCode!);
  }
