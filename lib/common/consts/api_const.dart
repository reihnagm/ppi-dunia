...
class ApiConsts {
  ...
  static const String baseUrlEcommerceDeliveryTimeslots =
      '$switchToBaseUrl/commerce-ppidunia/pub/v1/ninja/deliveryTimeSlots';
  ...
  static const String baseUrlEcommerce =
      '$switchToBaseUrl/commerce-ppidunia/api/v1';
  ...
  static const String baseUrlHelpPayment =
      'https://pg-$switchTo.connexist.id/payment/help/howto';
  ...
  static const String baseUrlEcommercePickupTimeslots =
      '$switchToBaseUrl/commerce-ppidunia/pub/v1/ninja/pickupTimeSlots';
  static const String baseUrlEcommerceDimensionSize =
      '$switchToBaseUrl/commerce-ppidunia/pub/v1/ninja/dimensionSizes';
  static const String baseUrlEcommerceApproximatelyVolumes =
      '$switchToBaseUrl/commerce-ppidunia/pub/v1/ninja/pickupApproxVolumes';

  static const String switchTo = 'prod';
  static const String switchToBaseUrl = "https://smsapi.connexist.com:8443";
  static const String switchToBaseUrlFeed =
      "https://api-ppidunia-forum.inovatif78.com/api/v1";
