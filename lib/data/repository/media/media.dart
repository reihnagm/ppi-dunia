  ...
  Future<Map<String, dynamic>> postMedia({
    ...
    try {
      FormData formData = FormData.fromMap({
        "folder": folder,
        "media": await MultipartFile.fromFile(media.path, filename: p.basename(media.path)),
      });
      Response res = await dioClient!.post("${AppConstants.baseUrl}/api/v1/media", data: formData);
