...
class _OnboardingWidgetState extends State<OnboardingWidget> {
  ...
  List<Map<String, dynamic>> assets = [
    {
      "image": AssetsConst.imageOnboardingBgOne,
      "text": "ONBOARDING_1",
    },
    {
      "image": AssetsConst.imageOnboardingBgTwo,
      "text": "ONBOARDING_2",
    },
    {
      "image": AssetsConst.imageOnboardingBgThree,
      "text": "ONBOARDING_3",
    },
  ];
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: const DecorationImage(
            image: AssetImage(AssetsConst.imageBackgroundPurplePlain),
            fit: BoxFit.cover),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              getTranslated(assets[index]["text"]),
