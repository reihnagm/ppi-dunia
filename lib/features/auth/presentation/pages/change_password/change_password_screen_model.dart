...
class ChangePasswordScreenModel
    with ChangeNotifier
    implements ChangePasswordScreenModelData {
  final AuthRepo ar;
  ...
  bool submissionValidation(
    ...
    if (oldPassword.isEmpty) {
      ...
      ShowSnackbar.snackbar(context, getTranslated('OLD_PASSWORD_LENGTH'), '',
          ColorResources.error);
      oldPasswordFn.requestFocus();
      return false;
  ...
  void submitControllerValue(BuildContext context) {
    ...
    if (isClear) {
      setChangePassword(context,
          newPassword: confirmPassword, oldPassword: oldPassword);
    }
