...
import 'package:ppidunia/features/auth/presentation/pages/sign_up/widgets/change_email_bottomsheet_widget.dart';
...
class OtpScreenModel with ChangeNotifier implements OtpScreenModelData {
  ...
  void _submissionValidation(BuildContext context, String otp) {
    if (otp.isEmpty) {
      ShowSnackbar.snackbar(
          context, getTranslated('EMPTY_OTP'), '', ColorResources.error);
      return;
    } else {
  ...
  @override
  Future<void> changeEmail(BuildContext context,
      {required String value, required String oldValue}) async {
    try {
