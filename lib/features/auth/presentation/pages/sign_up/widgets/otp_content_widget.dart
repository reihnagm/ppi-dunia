...
class _OngoingContentState extends State<OngoingContent> {
  ...
  String _parseSeconds(int value) {
    value++;
    if (value > 1)
      return "${getTranslated('RESEND_ATTEMPT')} $value ${getTranslated('PLURAL_SECOND')}";
        ...
        _startTimer
            ...
            : RichText(
                text: TextSpan(children: [
                  ...
                  TextSpan(
                    text: ' ${getTranslated("RESEND_OTP_TOGGLE")}',
