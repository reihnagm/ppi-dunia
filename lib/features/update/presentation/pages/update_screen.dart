...
import 'package:ppidunia/features/update/presentation/pages/update_state.dart';
                        ...
                        Padding(
                          ...
                          child:
                            ...
                            if (Platform.isAndroid)
                              Text(
                                getTranslated('NEW_VERSION_ANDROID'),
                                style: sfProRegular.copyWith(
                        ...
                        child: CustomButton(
                          onTap: () async {
                            final newVersion = NewVersionPlus(
                                androidId:
                                    'com.inovatif78.com.inovatif78.ppidunia',
                                iOSId:
                                    'com.inovatif78.com.inovatif78.ppidunia');
                            if (Platform.isAndroid) {
                              newVersion.launchAppStore(
                                  "https://play.google.com/store/apps/details?id=com.inovatif78.ppidunia");
                            } else {
