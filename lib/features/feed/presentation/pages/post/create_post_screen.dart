                                      ...
                                      child: InkWell(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Image.asset(
                                                AssetsConst.imageIcPoll,
                                                width: 20.0,
                                                height: 20.0,
                                              ),
                                              const SizedBox(width: 15.0),
                                              Text(
                                                getTranslated("CREATE_A_POLL"),
                                                style: const TextStyle(
                                                  color: ColorResources
                                                      .greyLightPrimary,
                                                  fontSize:
