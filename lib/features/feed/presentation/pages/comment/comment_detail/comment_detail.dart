                              ...
                              return Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text('@${data['display'].toString().replaceAll(
                                          ' ', '' 
                                        )}'),
                                      ],
                                    )
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  reply.user.uid == SharedPrefs.getUserId()
                                                    ...
                                                    Wrap(
                                                      children:  List.generate(reply.feedMention.length,(index){
                                                        return InkWell(
                                                          onTap: () => NS.push(context, ProfileViewScreen(userId:reply.feedMention[index].id)),
                                                          child: DetectableText(
                                                            text: '${reply.feedMention[index].name} ',
                                                            trimLines: 3,
                                                            trimLength: 100,
                                                            trimExpandedText: ' Show Less',
                                                            trimCollapsedText: 'Read More',
                                                            detectionRegExp: RegExp('(?<mention>@[a-zA-Z0-9_.]+)[^a-zA-Z0-9_.]'),
